...
import { ordersUpdateManyWithoutCustomersNestedInput } from '../orders/orders-update-many-without-customers-nested.input';
import { usersUpdateOneWithoutCustomersNestedInput } from '../users/users-update-one-without-customers-nested.input';

@InputType()
export class customersUpdateWithoutEmployeesInput {
    ...
    @Field(() => ordersUpdateManyWithoutCustomersNestedInput, {nullable:true})
