...
import { ordersCreateNestedManyWithoutCustomersInput } from '../orders/orders-create-nested-many-without-customers.input';
import { usersCreateNestedOneWithoutCustomersInput } from '../users/users-create-nested-one-without-customers.input';

@InputType()
export class customersCreateWithoutEmployeesInput {
    ...
    @Field(() => ordersCreateNestedManyWithoutCustomersInput, {nullable:true})
