...
import { invoicesUncheckedUpdateManyWithoutCustomersNestedInput } from '../invoices/invoices-unchecked-update-many-without-customers-nested.input';
...
@InputType()
export class customersUncheckedUpdateWithoutEmployeesInput {
    ...
    @Field(() => invoicesUncheckedUpdateManyWithoutCustomersNestedInput, {nullable:true})
