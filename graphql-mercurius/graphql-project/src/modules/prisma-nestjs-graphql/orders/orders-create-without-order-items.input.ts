...
import { usersCreateNestedOneWithoutOrdersInput } from '../users/users-create-nested-one-without-orders.input';
import { paymentsCreateNestedManyWithoutOrdersInput } from '../payments/payments-create-nested-many-without-orders.input';

@InputType()
export class ordersCreateWithoutOrder_itemsInput {
    ...
    @Field(() => usersCreateNestedOneWithoutOrdersInput, {nullable:true})
    @Type(() => usersCreateNestedOneWithoutOrdersInput)
