...
import { NestedEnumorders_statusWithAggregatesFilter } from './nested-enumorders-status-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumorders_statusFilter } from './nested-enumorders-status-filter.input';

@InputType()
export class Enumorders_statusWithAggregatesFilter {
