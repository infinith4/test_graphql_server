...
import { customersCreateNestedOneWithoutInvoicesInput } from '../customers/customers-create-nested-one-without-invoices.input';
...
export class invoicesCreateInput {
    ...
    @Field(() => customersCreateNestedOneWithoutInvoicesInput, {nullable:false})
