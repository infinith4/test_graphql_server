...
import { categoriesUpdateOneWithoutProductsNestedInput } from '../categories/categories-update-one-without-products-nested.input';

@InputType()
export class productsUpdateWithoutMerchantsInput {
    ...
    @Field(() => categoriesUpdateOneWithoutProductsNestedInput, {nullable:true})
