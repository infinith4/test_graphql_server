...
import { customersUpdateManyWithoutEmployeesNestedInput } from '../customers/customers-update-many-without-employees-nested.input';

@InputType()
export class employeesUpdateWithoutManage_areasInput {
    ...
    @Field(() => customersUpdateManyWithoutEmployeesNestedInput, {nullable:true})
