...
import { merchantsUpdateManyWithoutUsersNestedInput } from '../merchants/merchants-update-many-without-users-nested.input';
...
@InputType()
export class usersUpdateWithoutCountriesInput {
    ...
    @Field(() => merchantsUpdateManyWithoutUsersNestedInput, {nullable:true})
    merchants?: merchantsUpdateManyWithoutUsersNestedInput;
