...
import { merchantsUncheckedUpdateManyWithoutUsersNestedInput } from '../merchants/merchants-unchecked-update-many-without-users-nested.input';

@InputType()
export class usersUncheckedUpdateWithoutCountriesInput {
    ...
    @Field(() => merchantsUncheckedUpdateManyWithoutUsersNestedInput, {nullable:true})
    merchants?: merchantsUncheckedUpdateManyWithoutUsersNestedInput;
}
